...
namespace urna
{
    class Cadastro
    {
        public static void CadastrosPartido(List<Partido> partidos)
        {
            ...
            Console.WriteLine("\nOS PARTIDOS SERÃO CADASTRADOS AUTOMATICAMENTE");
            CadastroPartido.AutoCadastrarPartido(partidos); /*Cadastramento automatico*/
            //for (int i = 0; i < 100; i++)
            //{
        ...
        {
            Console.WriteLine("\nOS POLITICOS EXECUTIVOS SERAO CADASTRADOS AUTOMATICAMENTE");
            CadastroExecutivo.AutoCadastrar(partidos, presidentes, gorvenadores, prefeitos);
        ...
        {
            Console.WriteLine("\nOS POLITICOS LEGISLATIVOS SERAO CADASTRADOS AUTOMATICAMENTE");
            CadastroLegislativo.AutoCadastrar(partidos, deputadosEstaduais, deputadosFederais, vereadores);
            Console.WriteLine("CONCLUIDO");
