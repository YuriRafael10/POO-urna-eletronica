...
namespace urna
{
    class EleicoesMunicipais
    {
        ...
        //private static void ResultadoVereadores(List<Partido> partidos, List<Vereador> vereadores, int populacao)
        //{
        //    Console.WriteLine("\nVEREADORES\nVotos validos: " + TotalVotos.getVtsValidosVer() + " || Votos invalidos: " + TotalVotos.getVtsInvalidosVer(populacao));
        //    int ver1 = 0, ver2 = 0, ver3 = 0, ver4 = 0;
        //    foreach (Vereador vereador in vereadores)
        //    {
        //        if (vereador.getVotos() >= ver1)
        //        {
        //            ver1 = vereador.getVotos();
        //        }
        //    }
        //    if (ver2 == 0)
        //    {
        //        foreach (Vereador vereador in vereadores)
        //        {
        //            if (vereador.getVotos() >= ver2 && vereador.getVotos() != ver1)
        //            {
        //                ver2 = vereador.getVotos();
        //            }
        //        }
        //    }
        //    if (ver3 == 0)
        ...
        //        foreach (Vereador vereador in vereadores)
        //        {
        //            if (vereador.getVotos() >= ver3 && vereador.getVotos() != ver2 && vereador.getVotos() != ver1)
        //            {
        //                ver3 = vereador.getVotos();
        //            }
        //        }
        //    }
        //    if (ver4 == 0)
        ...
        //        foreach (Vereador vereador in vereadores)
        //        {
        //            if (vereador.getVotos() >= ver4 && vereador.getVotos() != ver3 && vereador.getVotos() != ver2 && vereador.getVotos() != ver1)
        //            {
        //                ver3 = vereador.getVotos();
        //            }
        //        }
        //    }
        //    Console.WriteLine("Os vereadores eleitos foram: ");
        //    foreach (Vereador vereador in vereadores)
        //    {
        //        if (vereador.getVotos() == ver1 || vereador.getVotos() == ver2 || vereador.getVotos() == ver3 || vereador.getVotos() == ver4)
        ...
        //    foreach (Vereador vereador in vereadores)
        //    {
        //        if (legenda.Equals(vereador.getLegenda()))
        //        {
        //            vereador.Votos();
        //            TotalVotos.VtsValidosVer();
        //            foreach (Partido partido in partidos)
        //            {
        //                if (vereador.getSigla().Equals(partido.getSigla()))
        //                    partido.numVotosVereador(vereador.getLegenda());
        //            }
        //        }
        //    }
        //}
        private static void VotarVereadores(List<Partido> partidos, List<Vereador> vereadores)
        {
            /*VOTOS AUTOMATICOS PARA VEREADOR*/
            Random r = new Random();
            ...
            foreach (Vereador vereador in vereadores)
            {
                ...
                {
                    vereador.Votos(); //Adiciona 1 voto pro vereador
        ...
        //    foreach (Prefeito prefeito in prefeitos)
        //    {
        //        if (legenda.Equals(prefeito.numeroPartido()))
        //        {
